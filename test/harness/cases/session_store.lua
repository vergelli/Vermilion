return function(H)
  ...
  ok(s.head.cfg.window_ms == 5000 and s.head.cfg.shield_window_ms == s.head.cfg.window_ms, "the head remembers the metric windows and shields share the damage window")
