return function(H)
  ...
  ok(label._text == start, "four steps forward come back to the first view")
  local n = 0
  for _ in pairs(seen) do n = n + 1 end
  ok(n == 4, "four distinct views cycle, got " .. n)
  ok(seen["SKILL"] and seen["TYPE"] and seen["OUTCOME"] and seen["CRIT"], "the views are SKILL, TYPE, OUTCOME and CRIT")
