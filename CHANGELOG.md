...
- Killing blows: a skull marks the moment of every kill you land, at the top of SKILL, TYPE and CRIT and on the victim's lane in PRESSURE. Hover it for the victim and the ability. The damage report counts them. Saved sessions keep them. A "Kill markers" toggle in Settings hides the skulls, for content where everything dies all the time; the report keeps counting.
