...
- TARGETS replaces OUTCOME: a heat lane per enemy showing who took your damage over time, hotter where you hit harder and orchid where a shield absorbed it. Lanes are ordered by damage taken, scroll with the mouse wheel, and hover shows the rate at that moment, the enemy's totals, its share of your output and the shields involved. Saved sessions keep it.
