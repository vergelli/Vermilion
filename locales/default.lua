...
ZO_CreateStringId("VERMILION_REPORT_ULT_READY", "Ultimate ready, unused")
ZO_CreateStringId("VERMILION_REPORT_TOP_SHIELD", "Cracked most")
ZO_CreateStringId("VERMILION_REPORT_TOP_TARGET", "Focused most")
ZO_CreateStringId("VERMILION_REPORT_KILLS",      "Killing blows")
ZO_CreateStringId("VERMILION_KILL_CARD",         "Killing blow  ·  %s")
ZO_CreateStringId("VERMILION_REPORT_FOCUS_TIME", "Time on main target")
ZO_CreateStringId("VERMILION_REPORT_SWITCHES",   "Target switches")
ZO_CreateStringId("VERMILION_TARGETH_DAMAGE",    "Damage")
ZO_CreateStringId("VERMILION_TARGETH_ABSORBED",  "Absorbed by shields")
ZO_CreateStringId("VERMILION_TARGETH_SHARE",     "Share of your output")
ZO_CreateStringId("VERMILION_TARGETS_SCROLLED",  "%d above  ·  %d below  ·  mouse wheel scrolls")
ZO_CreateStringId("VERMILION_REPORT_ULT_CASTS", "Ultimate casts")
ZO_CreateStringId("VERMILION_REPORT_APART",     "%d  ·  %s apart")
ZO_CreateStringId("VERMILION_ULT_CARD_READY",   "ready to cast")
ZO_CreateStringId("VERMILION_ULT_CARD_CHARGED", "%d%% charged")
...
ZO_CreateStringId("VERMILION_CONTRIB_ABSORBED",     "absorbed by shields")
